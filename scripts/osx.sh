setup_osx() {
  ...
  sudo scutil --set ComputerName "macbook-niels"
  sudo scutil --set HostName "macbook-niels"
  sudo scutil --set LocalHostName "macbook-niels"
  sudo defaults write /Library/Preferences/SystemConfiguration/com.apple.smb.server NetBIOSName -string "macbook-niels"
  ...
  # Disable auto boot when lid opens
